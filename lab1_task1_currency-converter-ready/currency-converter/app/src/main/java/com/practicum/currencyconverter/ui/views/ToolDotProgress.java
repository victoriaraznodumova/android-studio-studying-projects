package com.practicum.currencyconverter.ui.views;
...
public class ToolDotProgress extends View {
    ...
    private void applyAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            mDotRadius = a.getColor(R.styleable.ToolDotProgress_smallDotRadius, mDotRadius);
            mBigDotRadius = a.getColor(R.styleable.ToolDotProgress_bigDotRadius, mBigDotRadius);
            mDotStep = a.getColor(R.styleable.ToolDotProgress_dotStep, mDotStep);
            mDotColor = a.getColor(R.styleable.ToolDotProgress_dotColor, mDotColor);
            mDotCount = a.getInteger(R.styleable.ToolDotProgress_dotCount, mDotCount);
            mDotCount = Math.min(Math.max(mDotCount, MIN_COUNT), MAX_COUNT);
            mTimeout = a.getInteger(R.styleable.ToolDotProgress_dotTimeout, mTimeout);
